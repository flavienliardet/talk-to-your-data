...
export default function ChatPage() {
    ...
    return (
      <div className="flex h-screen items-center justify-center">
        <div className="text-center">
          <h1 className="mb-4 font-bold text-2xl">Erreur</h1>
  ...
  return (
    <Chat
      ...
      initialPersona={
        chat.lastPersona === 'Stock' || chat.lastPersona === 'Cdistrib'
          ? chat.lastPersona
          : 'Stock'
      }
      initialThinkingMode={
        chat.lastThinkingMode === 'Normal' ||
        chat.lastThinkingMode === 'Approfondi'
          ? chat.lastThinkingMode
          : 'Normal'
      }

...
export const PromptInput = ({ className, ...props }: PromptInputProps) => (
  <form
    className={cn(
      'w-full overflow-hidden rounded-lg border border-border/60 bg-background shadow-[var(--shadow-soft)] transition-shadow focus-within:border-[var(--gold-muted)] focus-within:shadow-md',
      className,
    )}
    {...props}
  />
